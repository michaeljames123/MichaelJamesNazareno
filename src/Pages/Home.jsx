...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/michaeljames123", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/drakqth/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/drakqth/?hl=id", label: "Instagram Profile" }
];
...
const Home = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Michael James A. Nazareno — Frontend Web Developer</title>
        <meta name="description" content="Website resmi Michael James A. Nazareno, Front-End Web Developer. Saya berfokus pada penciptaan pengalaman digital yang menarik dan selalu berupaya memberikan solusi terbaik dalam setiap proyek yang saya kerjakan." />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://michael.com" />
        <meta property="og:title" content="Michael James A. Nazareno — Frontend Web Developer" />
        <meta property="og:description" content="Website resmi dan portofolio Michael James A. Nazareno, Front-End Web Developer." />
        <meta property="og:url" content="https://Michael.com" />
        <meta property="og:type" content="website" />
        <script type="application/ld+json">{`
          {
            "@context": "https://schema.org",
            "@type": "Person",
            "name": "Michael James A. Nazareno",
            "jobTitle": "Frontend Developer",
            "url": "https://michael.com",
            "sameAs": [
              "https://github.com/michaeljames123",
              "https://www.linkedin.com/in/drakqth/",
              "https://www.instagram.com/drakqth/"
            ]
          }
        `}</script>
      </Helmet>
              ...
              <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0"
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light"
                    data-aos="fade-up"
                    data-aos-delay="1000">
                    Information Technology student with hands-on experience in software development, networking, and database management.
                  </p>
